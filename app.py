...
TRANS = {
    ...
    "🇫🇷 Français": {
        ...
        "subtitle": "**Ensemble Meta-Stacking Standardisé** | Aide à la Décision Clinique",
        ...
        * **Critère IRM :** Score PI-RADS Max ≥ 3.
        ...
        "opt_biopsy": ["Naïf (1ère fois)", "Négative Précédente", "Inconnu"],
        ...
        "calib_input": "Rendement Cible dans ROI (%):",
        "calib_info": "✅ Ajusté :",
        ...
        "warn_title": "### ⚠️ Attention Clinique : Hors Distribution",
    ...
    "🇻🇳 Tiếng Việt": {
        ...
        * **Yêu cầu MRI:** Điểm PI-RADS Max ≥ 3.
        ...
        "calib_input": "Tỷ lệ Mục tiêu trong ROI (%):",
